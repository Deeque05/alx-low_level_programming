0x00. C - Hello, World
In this project we have learnt how to use functions, compile, assemble, did more with scripts. 
We have also looked at some particular funtions in C, eg printf, getchar, etc 
